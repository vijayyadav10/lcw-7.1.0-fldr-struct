...
import { NO_DATA_AVAILABLE_MSG, STRAPI_EXCLUDE_KEYS, STRAPI_IMAGE_EXTENSIONS, STRAPI_IMAGE_HEIGHT, STRAPI_IMAGE_URL_KEY, STRAPI_IMAGE_WIDTH, UNIVERSAL_DATE_FORMAT } from './Constant';
...
export const renderPanelGroup = (data, strapiBaseUrl) => {
    ...
    return (
        <PanelGroup accordion id={panelGroupId} className="panel-group-mb5">
...
const renderPanelTitle = (theKey, data, strapiBaseUrl) => {
    return (
        <Panel.Title>
            <Grid.Row className="show-grid grid-row">
...
const renderAccordionData = (data, strapiBaseUrl) => {
    if (data === null || data === undefined) {
        ...
        return <span className="render-accordian-data">{data}</span>;
